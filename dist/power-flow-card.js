...
class PowerFlowCard extends LitElement {
  ...
  constructor() {
    super();
    this.svgPaths = {
      primary: './assets/grid_line.svg',
      out: './assets/grid_out.svg',
      solar: './assets/assets/solar_line.svg',
      battery: './assets/assets/home_battery.svg',
      ev: './assets/assets/ev_line.svg',
      bg: './assets/assets/home.svg',
    };
    ...
    this.lineConfig
      ...
      .forEach((cfg) => {
        ...
        if (container) {
          ...
          const isActive = Math.abs(value) > 10;
